...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description: 'Мед, продукти пасіки, натуральні продукти, квіти, лаванда, металопрофіль і товари для господарства. з перевірених джерел і зручним замовленням онлайн.',
    siteName: 'Дача TV',
