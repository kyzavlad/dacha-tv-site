...
export const metadata: Metadata = {
  title: 'Дача TV — натуральні продукти, товари для господарства та рішення для дому',
  description:
    'Мед і продукти пасіки, натуральні продукти господарства, квіти та лаванда, металопрофіль і покрівля, магазин товарів для дому й саду — напряму від виробників та партнерів на Харківщині.',
  alternates: { canonical: '/' },
  openGraph: {
    title: 'Дача TV — натуральні продукти та товари для господарства',
    description: 'Мед і продукти пасіки, квіти та лаванда, натуральні продукти, металопрофіль і магазин товарів — напряму від виробників та партнерів.',
    images: [{ url: '/images/dacha-tv/logo-square.png', width: 1200, height: 1200, alt: 'Дача TV — натуральні продукти та товари для господарства' }],
  },
}
