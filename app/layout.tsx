...
export const metadata: Metadata = {
  ...
  description:
    'Натуральний мед, пилок, прополіс та бджолині пакети від сімейної пасіки на Харківщині. Акація, Липа, Сонях — замовляйте напряму від пасічника.',
  keywords: ['мед', 'натуральний мед', 'купити мед Харків', 'мед Харківщина', 'пасіка', 'бджолопакети', 'Дача TV'],
  openGraph: {
    locale: 'uk_UA',
    type: 'website',
    siteName: 'Дача TV',
