...
//
// Selection reads the SQL queue (public.ru_product_seo_queue via
// public.get_ru_product_seo_candidate_ids) — it never paginates catalog_products.
//
//   GET /api/admin/seo/ru/product-ai-candidates?limit=100   (1–100, default 100)
...
export async function GET(req: Request) {
  ...
  try {
    ...
    console.info(`[seo-ru-candidates] req=${d.requested_limit} pool=${d.pool_limit} returned=${d.returned} scanned=${d.scanned} pages=${d.pages} missing=${d.missing_translation_found} partial=${d.partial_found} invalid=${d.invalid_found} locked=${d.locked_skipped} dup=${d.duplicate_skipped} complete=${d.complete_skipped} unmatched=${d.unmatched_skipped} end=${d.reached_end} capped=${d.scan_capped} — ${r.message}`)
