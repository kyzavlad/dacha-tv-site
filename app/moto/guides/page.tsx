...
const COPY = {
  uk: {
    ...
    description: 'Практичні чеклисти для Honda Dio, Yamaha Jog, Suzuki Lets та ключових вузлів скутера: карбюраторів, варіаторів, колінвалів, амортизаторів, глушників і замків запалювання.',
    home: 'Головна',
    guides: 'Поради',
  ...
  ru: {
    ...
    description: 'Практические чеклисты для Honda Dio, Yamaha Jog, Suzuki Lets и ключевых узлов скутера: карбюраторов, вариаторов, коленвалов, амортизаторов, глушителей и замков зажигания.',
    home: 'Главная',
    guides: 'Советы',
