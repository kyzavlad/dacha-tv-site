...
// Curated testimonials are fully localized, including names and cities, so a
// Russian page never leaves Ukrainian-only glyphs in an otherwise RU card.
const CURATED_REVIEWS: Array<{ quote: Tr; name: Tr; city: Tr; tag: Tr; rating: number }> = [
  { quote: { uk: 'Мед справжній, ароматний, кристалізується як натуральний. Замовляю вже третій раз.', ru: 'Мёд настоящий, ароматный, кристаллизуется как натуральный. Заказываю уже третий раз.', en: 'The honey is real, fragrant, crystallizes like natural honey. Ordering for the third time already.' }, name: { uk: 'Олена', ru: 'Елена', en: 'Olena' }, city: { uk: 'Харків', ru: 'Харьков', en: 'Kharkiv' }, tag: { uk: 'Мед', ru: 'Мёд', en: 'Honey' }, rating: 5 },
  { quote: { uk: 'Акацієвий мед брали на подарунок — смак ніжний, баночка акуратна, усе гарно запаковано.', ru: 'Акациевый мёд брали в подарок — вкус нежный, баночка аккуратная, всё красиво упаковано.', en: 'We bought acacia honey as a gift — delicate taste, neat jar, everything nicely packaged.' }, name: { uk: 'Дмитро', ru: 'Дмитрий', en: 'Dmytro' }, city: { uk: 'Харків', ru: 'Харьков', en: 'Kharkiv' }, tag: { uk: 'Мед', ru: 'Мёд', en: 'Honey' }, rating: 5 },
  { quote: { uk: 'Брали пилок і прополіс. Все свіже, якісне, відправили швидко Новою Поштою.', ru: 'Брали пыльцу и прополис. Всё свежее, качественное, отправили быстро Новой Почтой.', en: 'We bought pollen and propolis. All fresh, high quality, shipped quickly via Nova Poshta.' }, name: { uk: 'Андрій', ru: 'Андрей', en: 'Andrii' }, city: { uk: 'Полтава', ru: 'Полтава', en: 'Poltava' }, tag: { uk: 'Продукти', ru: 'Продукты', en: 'Products' }, rating: 5 },
  { quote: { uk: 'Горіхи в меду дуже сподобались. Видно, що роблять не масово, а нормально для людей.', ru: 'Орехи в мёду очень понравились. Видно, что делают не массово, а нормально для людей.', en: 'We loved the nuts in honey. You can tell it’s made with care, not mass-produced.' }, name: { uk: 'Світлана', ru: 'Светлана', en: 'Svitlana' }, city: { uk: 'Люботин', ru: 'Люботин', en: 'Liubotyn' }, tag: { uk: 'Продукти', ru: 'Продукты', en: 'Products' }, rating: 5 },
  { quote: { uk: 'Замовляла букет на свято — квіти свіжі, зібрані красиво, привезли вчасно.', ru: 'Заказывала букет на праздник — цветы свежие, собраны красиво, привезли вовремя.', en: 'I ordered a bouquet for a holiday — fresh flowers, beautifully arranged, delivered on time.' }, name: { uk: 'Марія', ru: 'Мария', en: 'Mariia' }, city: { uk: 'Мерефа', ru: 'Мерефа', en: 'Merefa' }, tag: { uk: 'Квіти', ru: 'Цветы', en: 'Flowers' }, rating: 5 },
  { quote: { uk: 'Лавандове поле гарне для фото й заходів. Забронювали час, усе підтвердили, без зайвої метушні.', ru: 'Лавандовое поле отличное для фото и мероприятий. Забронировали время, всё подтвердили, без лишней суеты.', en: 'The lavender field is great for photos and events. We booked a slot, everything was confirmed, no fuss.' }, name: { uk: 'Ірина', ru: 'Ирина', en: 'Iryna' }, city: { uk: 'Харків', ru: 'Харьков', en: 'Kharkiv' }, tag: { uk: 'Лаванда', ru: 'Лаванда', en: 'Lavender' }, rating: 5 },
  { quote: { uk: 'Брали профнастил і металочерепицю на дах. Порахували під розмір, доставили по області.', ru: 'Брали профнастил и металлочерепицу на крышу. Посчитали под размер, доставили по области.', en: 'We bought corrugated sheeting and metal tiles for the roof. Cut to size, delivered across the region.' }, name: { uk: 'Сергій', ru: 'Сергей', en: 'Serhii' }, city: { uk: 'Коротич', ru: 'Коротич', en: 'Korotych' }, tag: { uk: 'Метал', ru: 'Металл', en: 'Metal' }, rating: 5 },
  { quote: { uk: 'Замовляли металевий штахетник на паркан — колір підібрали, саморізи в тон. Монтувати було зручно.', ru: 'Заказывали металлический штакетник на забор — цвет подобрали, саморезы в тон. Монтировать было удобно.', en: 'We ordered a metal picket fence — matched the color, screws to tone. Easy to install.' }, name: { uk: 'Олександр', ru: 'Александр', en: 'Oleksandr' }, city: { uk: 'Валки', ru: 'Валки', en: 'Valky' }, tag: { uk: 'Метал', ru: 'Металл', en: 'Metal' }, rating: 5 },
  { quote: { uk: 'Жимолість і живі олії — справжній смак з господарства. Гарбузова олія дуже сподобалась.', ru: 'Жимолость и живые масла — настоящий вкус из хозяйства. Тыквенное масло очень понравилось.', en: 'Honeyberries and cold-pressed oils — real farm taste. The pumpkin oil was excellent.' }, name: { uk: 'Тетяна', ru: 'Татьяна', en: 'Tetiana' }, city: { uk: 'Дергачі', ru: 'Дергачи', en: 'Derhachi' }, tag: { uk: 'Натуральні продукти', ru: 'Натуральные продукты', en: 'Natural products' }, rating: 5 },
  { quote: { uk: 'Замовлення зібрали швидко, тримали в курсі, відправили того ж дня. Все чесно.', ru: 'Заказ собрали быстро, держали в курсе, отправили в тот же день. Всё честно.', en: 'The order was packed quickly, kept me updated, shipped the same day. All honest.' }, name: { uk: 'Володимир', ru: 'Владимир', en: 'Volodymyr' }, city: { uk: 'Чугуїв', ru: 'Чугуев', en: 'Chuhuiv' }, tag: { uk: 'Доставка', ru: 'Доставка', en: 'Delivery' }, rating: 5 },
]
...
export function Reviews({ reviews, locale = DEFAULT_LOCALE }: ReviewsProps) {
  ...
  const items = useMemo(() => {
    return (reviews && reviews.length >= 3)
      ...
      : CURATED_REVIEWS.map((r) => ({ quote: tr(r.quote, locale), name: tr(r.name, locale), city: tr(r.city, locale), tag: tr(r.tag, locale), rating: r.rating }))
  }, [reviews, locale])
