import { MERCHANT_CURRENT_QUARANTINE_IDS } from './merchant-current-quarantine'

export const MERCHANT_FEED_ORIGIN = 'https://dachatv.com'

// Merchant-only quarantine is refreshed from live Merchant Center diagnostics.
// Keep product rows live on the storefront; suppress only currently proven
// Merchant-action item defects from the Google feed until they are re-verified.
export const MERCHANT_VALIDATION_QUARANTINE_IDS = MERCHANT_CURRENT_QUARANTINE_IDS
