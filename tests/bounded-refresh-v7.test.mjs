...
test('config exposes EXISTING_REFRESH_BATCH_SIZE=1000 (lowered for the 3.7GiB server) and NEW_PRODUCT_INSERT_BATCH_CAP=500', () => {
  // The JS-caller default batch was reduced 5000 → 1000 to keep each import
  ...
  assert.equal(EXISTING_REFRESH_BATCH_SIZE, 1000)
